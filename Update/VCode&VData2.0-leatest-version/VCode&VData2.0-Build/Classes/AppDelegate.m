...
-(id)init
{
    ...
    if (self) {
        ...
        NSLog(@"I want to check this line...");
        ...
        [[tableView enclosingScrollView] setHasHorizontalRuler:NO];
        [tableView setBackgroundColor:[NSColor blackColor]];
...
//    NSURL * myurl2= [[NSURL alloc] initWithString:@"/Users/renpengyu/Desktop/Vcode/trunk/Update/Vcode&Vdata/VData2.png"];
   ...
   // NSImage *icon2 = [[NSImage alloc] initByReferencingFile:@"VReport.png"];
...
- (NSAttributedString *)prettyNameWithObject:(id)Object
{
    ...
    attachment = [[[NSTextAttachment alloc] init] autorelease];
    NSCell *cell = [attachment attachmentCell];
//    NSURL * myurl1=[[NSURL alloc] initWithString:@"./VCode1.png"];
    //    NSURL * myurl2= [[NSURL alloc] initWithString:@"/Users/renpengyu/Desktop/Vcode/trunk/Update/Vcode&Vdata/VData2.png"];
//    NSString * lsls= [NSString stringWithContentsOfURL:myurl1 encoding:nil error:NULL];
    NSImage *icon1 =[[NSImage imageNamed:@"VCode1.png"] autorelease]; // or wherever you are getting your image  /Users/quxcc5215/Documents/Vcode/trunk/Update/Vcode&Vdata/VCode1.png
//    NSImage *icon2 = [[NSImage alloc] initByReferencingFile:@"VCode1.png"];
//    NSLog(@"la %@",$(SRCROOT));
    NSSize mysize;
    mysize.height = 40;
    mysize.width = 35;
